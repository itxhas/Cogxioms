          ...
          {projects.map((project, index) => (
            <div className="project-card" key={project.title}>
              <div className="card-content">
                <img src={bakeryWebsite} alt={project.title} style={{ width: 80, height: 80, objectFit: 'contain', display: 'block', margin: '0 auto 1rem auto' }} />
                ...
                <button className="view-project-button" onClick={() => console.log('View project:', project.title)}>
                  View Project
                </button>
              </div>
            </div>
